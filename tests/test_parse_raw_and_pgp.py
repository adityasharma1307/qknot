...
from qresp.model import QLabel, SigAlgorithm, SigFormat, classify_algorithm
from qresp.parse import parse_gpg, parse_raw_signature, parse_signature
...
class TestRealWorldArtefacts:
    ...
    def test_old_format_two_octet_length_is_handled(self):
        ...
        from qresp.parse import _pgp_packet_body
